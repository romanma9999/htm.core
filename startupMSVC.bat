...
if %Has2019%==1 (
    cmake -G "Visual Studio 16 2019" -A x64 -Thost=x64 -DCMAKE_CONFIGURATION_TYPES="Release;Debug"  ../..
) else (
    if %Has2017%==1 (
      cmake -G "Visual Studio 15 2017 Win64" -Thost=x64 -DCMAKE_CONFIGURATION_TYPES="Release;Debug"  ../..
    ) else (
